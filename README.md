...
This is the preview branch of Stonks. This is the branch that gets updated the fastest, and is also the most unstable. Often, when we make major changes to Stonks, they get pushed to the preview branch first. It's essentially an extremely unstable preview of the next release version of stonks.

Current Changelog - Preview 1.00

 - Basic vaex implementation
